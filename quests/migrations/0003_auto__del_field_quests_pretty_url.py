...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Quests.pretty_url'
        db.delete_column(u'quests_quests', 'pretty_url')


    def backwards(self, orm):
        # Adding field 'Quests.pretty_url'
        db.add_column(u'quests_quests', 'pretty_url',
                      self.gf('django.db.models.fields.CharField')(default='jumpingjack', max_length=1000),
                      keep_default=False)
