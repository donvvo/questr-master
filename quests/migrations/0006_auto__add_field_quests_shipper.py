...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quests.shipper'
        db.add_column(u'quests_quests', 'shipper',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Quests.shipper'
        db.delete_column(u'quests_quests', 'shipper')
    ...
    models = {
        ...
        u'quests.quests': {
            ...
            'shipper': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
