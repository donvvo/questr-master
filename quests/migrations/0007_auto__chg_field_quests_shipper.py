...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Quests.shipper'
        db.alter_column(u'quests_quests', 'shipper', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Quests.shipper'
        db.alter_column(u'quests_quests', 'shipper', self.gf('django.db.models.fields.TextField')(default=''))
