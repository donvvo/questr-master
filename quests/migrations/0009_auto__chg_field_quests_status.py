...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Quests.status'
        db.alter_column(u'quests_quests', 'status', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Quests.status'
        db.alter_column(u'quests_quests', 'status', self.gf('django.db.models.fields.IntegerField')())
