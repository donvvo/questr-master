...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Quests.creation_date'
        db.alter_column(u'quests_quests', 'creation_date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Quests.creation_date'
        db.alter_column(u'quests_quests', 'creation_date', self.gf('django.db.models.fields.DateField')())
