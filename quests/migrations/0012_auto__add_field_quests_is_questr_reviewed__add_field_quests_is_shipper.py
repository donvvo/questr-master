...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quests.is_questr_reviewed'
        db.add_column(u'quests_quests', 'is_questr_reviewed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Quests.is_shipper_reviewed'
        db.add_column(u'quests_quests', 'is_shipper_reviewed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Quests.is_complete'
        db.add_column(u'quests_quests', 'is_complete',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Quests.is_questr_reviewed'
        db.delete_column(u'quests_quests', 'is_questr_reviewed')

        # Deleting field 'Quests.is_shipper_reviewed'
        db.delete_column(u'quests_quests', 'is_shipper_reviewed')

        # Deleting field 'Quests.is_complete'
        db.delete_column(u'quests_quests', 'is_complete')
