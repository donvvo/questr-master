...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Quests.item_images'
        db.alter_column(u'quests_quests', 'item_images', self.gf('django.db.models.fields.files.ImageField')(max_length=9999))

    def backwards(self, orm):

        # Changing field 'Quests.item_images'
        db.alter_column(u'quests_quests', 'item_images', self.gf('django.db.models.fields.URLField')(max_length=200))
