...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quests.distance'
        db.add_column(u'quests_quests', 'distance',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=1000, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Quests.distance'
        db.delete_column(u'quests_quests', 'distance')
