...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Quests.dropoff'
        db.alter_column(u'quests_quests', 'dropoff', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'Quests.pickup'
        db.alter_column(u'quests_quests', 'pickup', self.gf('jsonfield.fields.JSONField')())

    def backwards(self, orm):

        # Changing field 'Quests.dropoff'
        db.alter_column(u'quests_quests', 'dropoff', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Quests.pickup'
        db.alter_column(u'quests_quests', 'pickup', self.gf('django.db.models.fields.TextField')())
