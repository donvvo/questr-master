...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quests.delivery_date'
        db.add_column(u'quests_quests', 'delivery_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Quests.delivery_date'
        db.delete_column(u'quests_quests', 'delivery_date')
