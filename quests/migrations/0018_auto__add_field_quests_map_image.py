...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quests.map_image'
        db.add_column(u'quests_quests', 'map_image',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=9999),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Quests.map_image'
        db.delete_column(u'quests_quests', 'map_image')
    ...
    models = {
        ...
        u'quests.quests': {
            ...
            'delivery_code': ('django.db.models.fields.TextField', [], {'default': "'4a3fa'"}),
