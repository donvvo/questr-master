...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QuestTransactional'
        db.create_table(u'quests_questtransactional', (
            ('id', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ('quest_code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=64)),
            ('quest', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['quests.Quests'])),
            ('shipper', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.QuestrUserProfile'])),
            ('transaction_type', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('status', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'quests', ['QuestTransactional'])


    def backwards(self, orm):
        # Deleting model 'QuestTransactional'
        db.delete_table(u'quests_questtransactional')
    ...
    models = {
        ...
        u'quests.quests': {
            ...
            'delivery_code': ('django.db.models.fields.TextField', [], {'default': "'eaf75'"}),
