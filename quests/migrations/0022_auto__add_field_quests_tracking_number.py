...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quests.tracking_number'
        db.add_column(u'quests_quests', 'tracking_number',
                      self.gf('django.db.models.fields.TextField')(default='28b95ed3f0'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Quests.tracking_number'
        db.delete_column(u'quests_quests', 'tracking_number')
    ...
    models = {
        ...
        u'quests.quests': {
            ...
            'delivery_code': ('django.db.models.fields.TextField', [], {'default': "'0fa22'"}),
            ...
            'tracking_number': ('django.db.models.fields.TextField', [], {'default': "'28b95ed3f0'"})
        },
        u'quests.questtoken': {
