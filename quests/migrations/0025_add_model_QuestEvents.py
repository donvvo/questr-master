...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QuestEvents'
        db.create_table(u'quests_questevents', (
        ...
        db.send_create_signal(u'quests', ['QuestEvents'])


    def backwards(self, orm):
        # Deleting model 'QuestEvents'
        db.delete_table(u'quests_questevents')
