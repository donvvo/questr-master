...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestEvents.extrainfo'
        db.add_column(u'quests_questevents', 'extrainfo',
                      self.gf('jsonfield.fields.JSONField')(default='{}', max_length=9999),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestEvents.extrainfo'
        db.delete_column(u'quests_questevents', 'extrainfo')
