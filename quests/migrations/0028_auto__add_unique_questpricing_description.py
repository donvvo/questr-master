...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'QuestPricing', fields ['description']
        db.create_unique(u'quests_questpricing', ['description'])


    def backwards(self, orm):
        # Removing unique constraint on 'QuestPricing', fields ['description']
        db.delete_unique(u'quests_questpricing', ['description'])
