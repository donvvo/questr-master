...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'QuestPricing.description'
        db.delete_column(u'quests_questpricing', 'description')

        # Adding unique constraint on 'QuestPricing', fields ['questrs']
        db.create_unique(u'quests_questpricing', ['questrs_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'QuestPricing', fields ['questrs']
        db.delete_unique(u'quests_questpricing', ['questrs_id'])

        # Adding field 'QuestPricing.description'
        db.add_column(u'quests_questpricing', 'description',
                      self.gf('django.db.models.fields.TextField')(default='default', unique=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'quests.questpricing': {
            'Meta': {'object_name': 'QuestPricing'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pricing': ('jsonfield.fields.JSONField', [], {'default': '{}'}),
            'questrs': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.QuestrUserProfile']", 'unique': 'True'}),
            'updated_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'})
        },
        u'quests.quests': {
