...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quests.considered_couriers'
        db.add_column(u'quests_quests', 'considered_couriers',
                      self.gf('django.db.models.fields.TextField')(default=[]),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Quests.considered_couriers'
        db.delete_column(u'quests_quests', 'considered_couriers')
