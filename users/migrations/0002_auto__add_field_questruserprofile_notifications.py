...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestrUserProfile.notifications'
        db.add_column(u'users_questruserprofile', 'notifications',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestrUserProfile.notifications'
        db.delete_column(u'users_questruserprofile', 'notifications')
