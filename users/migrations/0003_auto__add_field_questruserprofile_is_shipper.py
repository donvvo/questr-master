...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestrUserProfile.is_shipper'
        db.add_column(u'users_questruserprofile', 'is_shipper',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestrUserProfile.is_shipper'
        db.delete_column(u'users_questruserprofile', 'is_shipper')
