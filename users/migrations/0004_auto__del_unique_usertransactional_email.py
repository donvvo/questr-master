...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'UserTransactional', fields ['email']
        db.delete_unique(u'users_usertransactional', ['email'])


    def backwards(self, orm):
        # Adding unique constraint on 'UserTransactional', fields ['email']
        db.create_unique(u'users_usertransactional', ['email'])
