...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestrUserProfile.rating'
        db.add_column(u'users_questruserprofile', 'rating',
                      self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=5, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestrUserProfile.rating'
        db.delete_column(u'users_questruserprofile', 'rating')
