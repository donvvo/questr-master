...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'QuestrUserProfile.notificationprefs'
        db.alter_column(u'users_questruserprofile', 'notificationprefs', self.gf('jsonfield.fields.JSONField')(max_length=9999))

    def backwards(self, orm):

        # Changing field 'QuestrUserProfile.notificationprefs'
        db.alter_column(u'users_questruserprofile', 'notificationprefs', self.gf('django.db.models.fields.CharField')(max_length=9999))
