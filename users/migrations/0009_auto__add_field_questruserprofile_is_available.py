...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestrUserProfile.is_available'
        db.add_column(u'users_questruserprofile', 'is_available',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestrUserProfile.is_available'
        db.delete_column(u'users_questruserprofile', 'is_available')
