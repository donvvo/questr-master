...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestrUserProfile.address'
        db.add_column(u'users_questruserprofile', 'address',
                      self.gf('jsonfield.fields.JSONField')(default='{}', max_length=9999),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestrUserProfile.address'
        db.delete_column(u'users_questruserprofile', 'address')
