...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'QuestrUserProfile.avatar_file_name'
        db.delete_column(u'users_questruserprofile', 'avatar_file_name')

        # Adding field 'QuestrUserProfile.avatar'
        db.add_column(u'users_questruserprofile', 'avatar',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=1024, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'QuestrUserProfile.avatar_file_name'
        db.add_column(u'users_questruserprofile', 'avatar_file_name',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=9999),
                      keep_default=False)

        # Deleting field 'QuestrUserProfile.avatar'
        db.delete_column(u'users_questruserprofile', 'avatar')
