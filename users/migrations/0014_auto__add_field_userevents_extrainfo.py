...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserEvents.extrainfo'
        db.add_column(u'users_userevents', 'extrainfo',
                      self.gf('jsonfield.fields.JSONField')(default='{}', max_length=9999),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserEvents.extrainfo'
        db.delete_column(u'users_userevents', 'extrainfo')
