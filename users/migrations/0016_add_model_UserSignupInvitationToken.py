...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserSignupInvitationToken'
        db.create_table(u'users_usersignupinvitationtoken', (
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=100)),
            ('token', self.gf('django.db.models.fields.CharField')(max_length=20, primary_key=True)),
            ('timeframe', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('status', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'users', ['UserSignupInvitationToken'])


    def backwards(self, orm):
        # Deleting model 'UserSignupInvitationToken'
        db.delete_table(u'users_usersignupinvitationtoken')
