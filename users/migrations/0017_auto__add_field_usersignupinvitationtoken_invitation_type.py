...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserSignupInvitationToken.invitation_type'
        db.add_column(u'users_usersignupinvitationtoken', 'invitation_type',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserSignupInvitationToken.invitation_type'
        db.delete_column(u'users_usersignupinvitationtoken', 'invitation_type')
    ...
    models = {
        ...
        u'users.usersignupinvitationtoken': {
            ...
            'invitation_type': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
