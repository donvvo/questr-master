...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserSignupInvitationToken.invitation_type'
        db.alter_column(u'users_usersignupinvitationtoken', 'invitation_type', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'UserSignupInvitationToken.invitation_type'
        db.alter_column(u'users_usersignupinvitationtoken', 'invitation_type', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'users.usersignupinvitationtoken': {
            'Meta': {'object_name': 'UserSignupInvitationToken'},
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '100'}),
            'invitation_type': ('django.db.models.fields.CharField', [], {'default': "'Courier'", 'max_length': '20'}),
